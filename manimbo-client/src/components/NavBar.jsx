  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#eee2d6] bg-white/92 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-6 lg:px-10">
        ...
        <NavLink
          to="/auth/signin"
          className="inline-flex items-center justify-center rounded-full border border-[#e7dacc] bg-white px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#2f241f] shadow-[0_8px_20px_rgba(95,74,49,0.07)] transition duration-300 hover:-translate-y-[1px] hover:border-[#cfb49d] hover:bg-[#fdfaf6] hover:shadow-[0_14px_26px_rgba(95,74,49,0.11)] md:hidden"
        >
          Sign In
        </NavLink>
      </div>
